...
const LoginCoach = () => {
    ...
    const handleLogin = async (e) => {
        ...
        if (loginSuccess) {
            console.log("Login exitoso, coach ID:", store.loggedInCoach.id); // Verifica ID aquí
        } else {
    ...
    useEffect(() => {
        // Verificar si loggedInCoach se actualiza
        if (store.loggedInCoach) {
            console.log("Coach logueado:", store.loggedInCoach); // Log para verificar
    ...
    useEffect(() => {
        // Verifica si coachInfo está completo
        if (store.coachInfo) {
            console.log("coachInfo actual:", store.coachInfo); // Log para verificar
