...
import '../../styles/loginSmoker.css'; // Asegúrate de que este archivo contenga los estilos correctos

const LoginSmoker = () => {
    const { actions, store } = useContext(Context); // Acceso al contexto
    ...
    const handleLogin = async (event) => {
        ...
        try {
            const isSuccess = await actions.loginSmoker(smokerData);
            if (isSuccess) {
                ...
                if (userId) {
                    const userInfo = await actions.getUserInfo(userId);

                    if (userInfo) {
                        const {
                            numero_cigarrillos,
                            periodicidad_consumo,
                        } = userInfo;

                        if (numero_cigarrillos !== null && periodicidad_consumo) {
    ...
    return (
        <div className="form-container">
            ...
            <div className="social-message">
                ...
                <p className="message">Iniciar sesión con redes sociales</p>
                <div className="line"></div>
            </div>
            ...
            <p className="signup">¿No tienes una cuenta?
                <a rel="noopener noreferrer" href="/signup-smoker" className=""> Regístrate</a>
            </p>
        </div>
    );
};
